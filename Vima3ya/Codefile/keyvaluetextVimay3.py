...
# Load JSON File
# ------------------------------
input_path = "../arrayjson/vima3ya_213.json"  # update path as needed
...
if invoice_raw and ThreeDConstants.Constant_Invoice in invoice_raw:
    parts = invoice_raw.split("\n")
    if len(parts) >= 2:
        result[ThreeDConstants.Constant_Invoice] = parts[1].strip()
...
output_folder = '../keyvaluejsonVima3ya'
